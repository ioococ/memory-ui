...
const routes = [
  ...
  { path: '/admin', redirect: '/welcome', meta: {requiresAuth: true}, component: () => import('@/view/admin/admin.vue'),
    children: [
      ...
      { path: '/webEdit', name: 'webEdit', component: () => import('@/components/admin/editpage/webEdit.vue') },
      ...
      { path: '/postEdit', name: 'postEdit', component: () => import('@/components/admin/editpage/postEdit.vue') },
      { path: '/sortList', name: 'sortList', component: () => import('@/view/admin/sortList.vue') },
      { path: '/diaryList', name: 'diaryList', component: () => import('@/view/admin/diaryList.vue') },
      { path: '/diaryEdit', name: 'diaryEdit', component: () => import('@/components/admin/editpage/diaryEdit.vue') },
