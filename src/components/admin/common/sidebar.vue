<template>
  <div class="sidebar">
    <el-menu class="sidebar-el-menu" background-color="#ebf1f6" text-color="#606266" active-text-color="#20a0ff" unique-opened router>
            ...
            <el-submenu :index="item.index" :key="item.index">
              ...
              <template v-for="subItem in item.subs">
                <el-submenu v-if="subItem.subs" :index="subItem.index" :key="subItem.index">
                  ...
                  <el-menu-item v-for="threeItem in subItem.subs" :key="threeItem.index" :index="threeItem.index">{{ threeItem.title }}</el-menu-item>
                </el-submenu>
    ...
    data() {
      return {
        ...
        items: [
          ...
          // {icon: "el-icon-sugar", index: "/loveList", title: "表白墙管理", isBoss: true}
        ]
      }
    },
