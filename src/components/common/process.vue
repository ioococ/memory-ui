  ...
  <div v-if="!$common.isEmpty(treeHoleList)">
    <div class="process-line">
      <div class="process-item"
           ...
           :key="index">
        <div class="treehole-item-time">
          <span>
            {{$common.getDateDiff(treeHole.createTime)}}
          </span>
          <span @click="deleteTreeHole(treeHole.id)" class="process-delete" v-if="!$common.isEmpty($store.state.currentUser) && $store.state.currentUser.id === treeHole.userId">
        ...
        <div class="treehole-item-content" v-html="treeHole.content"></div>
      </div>
    </div>
  </div>
</template>
