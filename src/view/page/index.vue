          ...
          <div class="page-container">
            ...
            <div class="recent-posts">
              <div class="announcement background-opacity">
                ...
                <div><div v-for="(notice, index) in $store.state.webInfo.notices" :key="index">{{ notice }}</div></div>
              </div>
...
<script>
  const loader = () => import("@/components/page/common/loader.vue");
  const zombie = () => import("@/components/page/funny/zombie.vue");
  const printer = () => import("@/components/page/funny/printer.vue");
  const articleList = () => import("@/components/page/layout/articleList.vue");
  const sortArticle = () => import("@/components/page/layout/sortArticle.vue");
  const myFooter = () => import("@/components/page/skeleton/myFooter.vue");
  const myAside = () => import("@/components/page/skeleton/myAside.vue");
